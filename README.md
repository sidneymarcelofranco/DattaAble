...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-24 18:46`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/adeb640d-578e-4635-8f4a-a542a8901ad4.git
$ cd adeb640d-578e-4635-8f4a-a542a8901ad4
```
